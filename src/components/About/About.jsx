    ...
    <article className='about-wrapper' id='about'>
        ...
        <div className='about-section-wrapper'>
          ...
          <div className='about-section'>
            <p>I specialize in frontend development, although love to do backend work when I can. I have done work in software development, front-end/back-end web, database/server management, graphic design, and video game development. I love helping out developers where I can, and currently am a Code Reviewer for a website known as Codefling.com. I make sure that all developers are pushing through fast and responsive code as well as providing feedback where I can.</p>
            <h1>My Skills:</h1>
